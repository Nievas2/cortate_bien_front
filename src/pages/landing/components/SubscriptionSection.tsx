...
const SubscriptionSection = () => {
  ...
  const getPopularPlan = (plans: Plan[]) => {
    ...
    return plans.reduce((prev, current) => (prev.precio > current.precio) ? prev : current)
  }
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <svg className="absolute inset-0 w-full h-full opacity-10">
          <defs>
            <linearGradient id="subscriptionLineGradient" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full max-w-7xl mx-auto px-4 gap-16">
            ...
            data?.data.map((plan: Plan, index: number) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Tarjeta principal */}
                  <div className={`relative flex flex-col gap-6 p-8 rounded-2xl border transition-all duration-500 hover:scale-105 h-full ${
                    isPopular 
        ...
        <div className="flex flex-col items-center gap-4 text-center">
          <p className="text-gray-400 text-lg">
            ...
            <span className="text-blue-400 hover:text-blue-300 font-medium underline transition-colors duration-300 cursor-pointer">
              Contáctanos
            </span>
          </p>
        </div>
