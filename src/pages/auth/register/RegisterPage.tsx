 ...
 */}
        ...
        <Dialog open={modal} onOpenChange={() => setModal(!modal)}>
          <DialogContent forceMount>
            ...
            <p>
              Al registrarte como barbero, activás automáticamente el plan
              Premium por 30 días, sin necesidad de esperar aprobación.
            </p>
            <p>
              🔓 Gestioná tu barbería al instante: podés hacer cambios, agregar
              servicios, horarios y más, ¡sin demoras ni intermediarios! ¡Empezá
              a usar todas las funciones ahora mismo! 💈
            </p>
