    ...
    <div className="flex flex-col gap-8 items-center justify-center p-6">
      ...
      <ol className="flex flex-col gap-3 ">
        ...
        <li className="first-letter:font-bold">
          ...
          personales. Para ejercer estos derechos, contáctanos en angelgabrielnievas@gmail.com.
        </li>
        ...
        <li className="first-letter:font-bold">
          ...
          significativos. Si tienes preguntas, no dudes en escribirnos a angelgabrielnievas@gmail.com.
        </li>
      </ol>
    </div>
  )
